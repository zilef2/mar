...
const titulos = [
    { order: 'reference', label: 'reference', type: 'string' },
    { order: 'description', label: 'description', type: 'string' },
    { order: 'value', label: 'value', type: 'number' },
    { order: 'discounted_value', label: 'discounted_value', type: 'number' },
    { order: 'unit_price', label: 'unit_price', type: 'number' },
];
