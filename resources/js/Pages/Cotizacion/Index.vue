...
import {ChevronUpDownIcon, PencilIcon, TrashIcon, DocumentTextIcon} from '@heroicons/vue/24/solid';
...
const titulos = [
    { order: 'engineer_name', label: 'engineer_name', type: 'string' },
    { order: 'company', label: 'company', type: 'string' },
    { order: 'project', label: 'project', type: 'string' },
    { order: 'date', label: 'date', type: 'date' },
    { order: 'subtotal', label: 'subtotal', type: 'number' },
    { order: 'tax_rate', label: 'tax_rate', type: 'number' },
    { order: 'tax_amount', label: 'tax_amount', type: 'number' },
    { order: 'total', label: 'total', type: 'number' },
    { order: 'status', label: 'status', type: 'string' },
];
            ...
            <div class="px-4 sm:px-0">
                <div class="rounded-lg overflow-hidden w-fit">
                    ...
                    <Edit v-if="can(['update Cotizacion'])" :titulos="titulos"
                        ...
                        :Cotizaciona="data.Cotizaciono" :title="props.title" :losSelect=props.losSelect />
                                ...
                                <td v-if="numberPermissions > 1" class="whitespace-nowrap py-4 w-12 px-2 sm:py-3">
                                    <div class="flex justify-center items-center">
                                        <div class="rounded-md overflow-hidden flex">
                                            <a :href="route('Cotizacion.pdf', claseFromController.id)" target="_blank"
                                                class="inline-flex items-center justify-center px-2 py-1.5 bg-blue-600 border border-transparent rounded-none text-white hover:bg-blue-500 active:bg-blue-700 focus:outline-none transition ease-in-out duration-150"
                                                v-tooltip="'Generar PDF'">
                                                <DocumentTextIcon class="w-4 h-4" />
                                            </a>
                                            <InfoButton v-show="can(['update Cotizacion'])" type="button"
